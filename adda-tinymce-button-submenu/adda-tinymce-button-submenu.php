<?php
/**
 * @package Adda TinyMCE Button Submenu
 * @version 1.1
 */
/*
...
if ( ! class_exists( 'Adda_Tinymce_Button_Submenu' ) ):
class Adda_Tinymce_Button_Submenu {
	...
	public function adda_add_tinymce_plugin( $plugin_array ) {
		$plugin_array['adda_button'] = plugin_dir_url(__FILE__) . 'js/adda-submenu-button.js';
		return $plugin_array;
	}
...
new Adda_Tinymce_Button_Submenu();
